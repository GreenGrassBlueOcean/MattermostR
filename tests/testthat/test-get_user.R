...
test_that("get_user() works as expected", {
  ...
  result <- get_user(user_id = "123", auth = mock_auth)
  ...
  expect_error(get_user(user_id = "invalid-user", auth = mock_auth), "User not found")
})
